...
class EnvironmentBuilderHelperTest {
    ...
    void addressResolverClassReceivesMappedHostPort() throws Exception {
        ConnectorOptions options = new ConnectorOptions(Map.of(
                ...
                "stream", "test-stream",
                "addressResolverClass", "io.github.lukaszsamson.spark.rabbitmq.EnvironmentBuilderHelperTest$TestAddressResolver"
        ));
    ...
    void observationCollectorClassConfiguresBuilderCollector() throws Exception {
        ConnectorOptions options = new ConnectorOptions(Map.of(
                ...
                "io.github.lukaszsamson.spark.rabbitmq.EnvironmentBuilderHelperTest$TestObservationCollectorFactory"
        ));
    ...
    void observationCollectorClassReturningNullFailsFast() {
        ConnectorOptions options = new ConnectorOptions(Map.of(
                ...
                "stream", "test-stream",
                "observationCollectorClass",
                "io.github.lukaszsamson.spark.rabbitmq.EnvironmentBuilderHelperTest$NullObservationCollectorFactory"
        ));
    ...
    void observationRegistryProviderClassConfiguresMicrometerCollector() throws Exception {
        ConnectorOptions options = new ConnectorOptions(Map.of(
                ...
                "io.github.lukaszsamson.spark.rabbitmq.EnvironmentBuilderHelperTest$TestObservationRegistryProvider"
        ));
    ...
    void observationRegistryProviderClassReturningNullFailsFast() {
        ConnectorOptions options = new ConnectorOptions(Map.of(
                ...
                "stream", "test-stream",
                "observationRegistryProviderClass",
                "io.github.lukaszsamson.spark.rabbitmq.EnvironmentBuilderHelperTest$NullObservationRegistryProvider"
        ));
    ...
    void compressionCodecFactoryClassConfiguresBuilderFactory() throws Exception {
        ConnectorOptions options = new ConnectorOptions(Map.of(
                ...
                "io.github.lukaszsamson.spark.rabbitmq.EnvironmentBuilderHelperTest$TestCompressionCodecFactory"
        ));
    ...
    void compressionCodecFactoryClassReturningNullFailsFast() {
        ConnectorOptions options = new ConnectorOptions(Map.of(
                ...
                "stream", "test-stream",
                "compressionCodecFactoryClass",
                "io.github.lukaszsamson.spark.rabbitmq.EnvironmentBuilderHelperTest$NullCompressionCodecFactory"
        ));
